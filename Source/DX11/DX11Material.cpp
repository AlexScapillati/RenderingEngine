...
namespace DX11
{
	CDX11Material::CDX11Material(std::vector<std::string> fileMaps, CDX11Engine* engine)
	{
		mEngine = engine;
	...
	CDX11Material::CDX11Material(CDX11Material& m)
	{
		mEngine = m.mEngine;
	...
	void CDX11Material::RenderMaterial(bool basicGeometry)
	{
	...
	void CDX11Material::SetVertexShader(ID3D11VertexShader* s)
	{
		mVertexShader = s;
	}

	void CDX11Material::SetPixelShader(ID3D11PixelShader* s)
	{
		mPixelShader = s;
	}

	void CDX11Material::LoadMaps(std::vector<std::string>& fileMaps)
	{
