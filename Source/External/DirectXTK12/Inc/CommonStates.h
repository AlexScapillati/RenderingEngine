...
namespace DirectX
{
    ...
    public:
        ...
        static const D3D12_STATIC_SAMPLER_DESC StaticAnisotropicBorder(unsigned int shaderRegister, D3D12_SHADER_VISIBILITY shaderVisibility = D3D12_SHADER_VISIBILITY_ALL, unsigned int registerSpace = 0) noexcept;
