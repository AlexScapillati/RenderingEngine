...
struct ImFontGlyph
{
    ...
    float           U0, V0, U1, V1;     // Albedo coordinates
};
...
struct ImFontAtlas
{
    ...
    int                         TexDesiredWidth;    // Albedo width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.
    ...
    int                         TexWidth;           // Albedo width calculated during Build().
    int                         TexHeight;          // Albedo height calculated during Build().
    ImVec2                      TexUvScale;         // = (1.0f/TexWidth, 1.0f/TexHeight)
    ImVec2                      TexUvWhitePixel;    // Albedo coordinates to a white pixel
