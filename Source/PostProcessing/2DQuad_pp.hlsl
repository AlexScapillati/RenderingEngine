...
PostProcessingInput main(uint vertexId : SV_VertexID)
{
	...
	output.areaUV  = areaCoord;  // These UVs refer to the area being post-processed (see ascii diagram below)
	output.sceneUV = quadCoord;  // These UVs refer to the scene texture (see diagram below)
